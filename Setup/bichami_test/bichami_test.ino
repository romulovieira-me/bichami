...
const unsigned int outPort = 9999; // Porta remota para enviar dados OSC
const unsigned int outPort2 = 7777; // Porta 2 remota para enviar dados OSC
const unsigned int localPort = 2390; // Porta local para receber pacotes OSC

// Declarando variáveis
char ssid[] = "rede2"; // EDITAR: Nome da rede
char pass[] = "12345678"; // EDITAR: senha da rede
...
int maxVal=65536; // Valor máximo do MPU6050
